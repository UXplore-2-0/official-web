        ...
        <div class="container mx-auto ">
            <div class="lg:flex bg-brown bg-blue flex-wrap lg:mx-5 py-7">
                <div class="box1 lg:basis-1/2 md:text-center text-center sm:text-center lg:text-start">
                    <span class="lg:text-[124px] md:text-[90px] sm:text-[64px] text-[48px] leading-[1]  font-[300] heading" style={{ fontFamily: "sans-serif" }}>
                    <div class="text-white text1">WHAT IS</div> <div class="text-white text2">UXPLORE</div>  <div class="text-white text3"> 2.0</div>

                    </span>
                    <img src={logo} alt="" className="logo w-48 lg:mt-16 md:hidden sm:hidden hidden lg:block opacity-1"/>
                </div>
                <div class="box2  lg:basis-4/6 lg:mt-72 md:mt-8 sm:mt-8 mt-10 lg:-mx-60 mx-10">
