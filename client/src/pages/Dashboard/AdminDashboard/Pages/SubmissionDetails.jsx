...
function SubmissionDetails() {
    ...
    const Team_Details = [
        {
            teamName: 'Team 1', email: 'team1@example.com',
            universityName: 'University 1', Link: 'https://www.google.com', Date: '12/12/2021', submit: true,
        },
        {
            teamName: 'Team 2', email: 'team2@example.com',
            universityName: 'University 2', Link: 'https://www.google.com', Date: '12/12/2021', submit: true,
        },
        {
            teamName: 'Team 3', email: 'team3@example.com',
            universityName: 'University 3', Link: 'https://www.google.com', Date: '12/12/2021', submit: false,
        },
    ];
                    ...
                    {Team_Details.map((team, index) => (
                        <tr key={index}>
                            ...
                            <td className="px-6 py-3">
                                {team.submit ? <span className="bg-green-500 text-white px-2 py-1 rounded-full text-xs">Submitted</span> : <span className="bg-red-500 text-white px-2 py-1 rounded-full text-xs">Not Submitted</span>}
                            </td>
                        </tr>
                    ))}
                </tbody>
