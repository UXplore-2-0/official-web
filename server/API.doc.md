...
- Team
  ...
  - email `(unique)`
  - password
  - team_members `(array of member_ids)`
  - is_verfiied
  - verification_token
...
![alt text](MoraUXPlore-2.0-ER.drawio.png)
...
- The `helper` folder contains all the helper functions.
...
- The `views` folder contains all the views for the server like email views.
